...
#define DEBUG_GPRS_ON 0
#if DEBUG_GPRS_ON
	#define DEBUG_GPRS(fmt,args...) printf (fmt ,##args)
#else
	#define DEBUG_GPRS(fmt,args...)
#endif
...
extern  sim900a_res_e   gps_to_place(float longitude,float latitude);
